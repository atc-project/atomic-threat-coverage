...
<details>
  <summary>Аналитическая дашборда ATC в Кибане (кликните чтобы раскрыть)</summary>
...
1. Клонируйте репозиторий или скачайте [архив](https://github.com/krakow2600/atomic-threat-coverage/archive/master.zip)
...
5. Обновите `scripts/config.yml`, указав ссылки на Вашу инсталляцию  Confluence  (тут могут помочь инструкции внутри дефолтного конфигурационного файла)
...
Если Вы хотите только посмотреть на конечный результат, Вы можете посмоотреть на онлайн [демо](https://atomicthreatcoverage.atlassian.net/wiki/spaces/ATC/pages/126025996/WMI+Persistence+-+Script+Event+Consumer) c автоматически сгенерированной Confluence базой. 
...
Если Вы хотите частично сгенерировать/обновить аналитику, вы можете посмотреть, какие параметры принимает `Makefile` или помощь  `scripts/main.py`. 
