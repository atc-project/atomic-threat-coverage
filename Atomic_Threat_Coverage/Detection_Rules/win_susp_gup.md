...
title: Suspicious GUP Usage status: experimental \
description: Detects execution of the Notepad++ updater in a suspicious directory, which is often used in DLL side-loading attacks \
...
author: Florian Roth \
date:  \
falsepositives: ['Execution of tools named GUP.exe and located in folders different than Notepad++\\updater'] \
level: high
...
search = (Image="*\\GUP.exe" NOT ((Image="C:\\Users\\*\\AppData\\Local\\Notepad++\\updater\\gup.exe" OR Image="C:\\Users\\*\\AppData\\Roaming\\Notepad++\\updater\\gup.exe" OR Image="C:\\Program Files\\Notepad++\\updater\\gup.exe" OR Image="C:\\Program Files (x86)\\Notepad++\\updater\\gup.exe"))) | stats values(*) AS * by _time | search NOT [| inputlookup Suspicious_GUP_Usage_whitelist.csv] | collect index=threat-hunting marker="sigma_tag=attack.defense_evasion,sigma_tag=attack.t1073,level=high"
```
