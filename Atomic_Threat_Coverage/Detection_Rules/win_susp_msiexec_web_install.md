...
```
(EventID:"1" AND CommandLine.keyword:(*\\ msiexec*\\:\\\\\\/\\\\\\/*))\n(EventID:"4688" AND ProcessCommandLine.keyword:(*\\ msiexec*\\:\\\\\\/\\\\\\/*))
```
...
```
(EventID:"1" AND CommandLine:("* msiexec*\\:\\\\\\/\\\\\\/*"))\n(EventID:"4688" AND ProcessCommandLine:("* msiexec*\\:\\\\\\/\\\\\\/*"))
```
