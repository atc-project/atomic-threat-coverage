...
```
((EventID:"5145" AND ShareName:"\\\\*\\\\IPC$" AND RelativeTargetName.keyword:(*\\-stdin OR *\\-stdout OR *\\-stderr)) AND (NOT (EventID:"5145" AND ShareName:"\\\\*\\\\IPC$" AND RelativeTargetName.keyword:PSEXESVC*)))
```
