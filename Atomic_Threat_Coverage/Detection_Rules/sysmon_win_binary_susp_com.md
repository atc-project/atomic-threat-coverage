...
```
(EventID:"3" AND DestinationHostname.keyword:(*dl.dropboxusercontent.com OR *.pastebin.com OR *.githubusercontent.com) AND Image:"C\\:\\\\Windows\\\\*")
```
