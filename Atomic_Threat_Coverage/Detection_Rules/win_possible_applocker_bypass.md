...
```
CommandLine.keyword:(*\\\\msdt.exe* OR *\\\\installutil.exe* OR *\\\\regsvcs.exe* OR *\\\\regasm.exe* OR *\\\\regsvr32.exe* OR *\\\\msbuild.exe* OR *\\\\ieexec.exe* OR *\\\\mshta.exe*)
```
