...
| ATT&amp;CK Technique | <ul><li>[T1107: File Deletion](https://attack.mitre.org/tactics/T1107)</li></ul>                             |
| Data Needed          | <ul></ul>                                                         |
| Trigger              | <ul><li>[('File Deletion', 'T1107')](../Triggers/('File Deletion', 'T1107').md)</li></ul>  |
