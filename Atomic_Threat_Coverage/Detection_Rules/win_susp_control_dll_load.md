...
title: Suspicious Control Panel DLL Load status: experimental \
description: Detects suspicious Rundll32 execution from control.exe as used by Equation Group and Exploit Kits \
references: ['https://twitter.com/rikvduijn/status/853251879320662017'] \
tags: ['attack.defense_evasion', 'attack.t1073', 'attack.t1085', 'car.2013-10-002'] \
author: Florian Roth \
date:  \
...
search = ((ParentImage="*\\System32\\control.exe" CommandLine="*\\rundll32.exe *") NOT (CommandLine="*Shell32.dll*")) | table CommandLine,ParentCommandLine,host | search NOT [| inputlookup Suspicious_Control_Panel_DLL_Load_whitelist.csv] | collect index=threat-hunting marker="sigma_tag=attack.defense_evasion,sigma_tag=attack.t1073,sigma_tag=attack.t1085,sigma_tag=car.2013-10-002,level=high"
```
