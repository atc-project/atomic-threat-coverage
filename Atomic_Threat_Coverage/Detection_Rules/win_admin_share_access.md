...
| ATT&amp;CK Technique | <ul><li>[T1077: Windows Admin Shares](https://attack.mitre.org/tactics/T1077)</li></ul>                             |
...
| Trigger              | <ul><li>[('Windows Admin Shares', 'T1077')](../Triggers/('Windows Admin Shares', 'T1077').md)</li></ul>  |
| Severity Level       | low                                                                                                                                                 |
