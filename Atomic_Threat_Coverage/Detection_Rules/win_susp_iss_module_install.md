...
```
(EventID="1" (CommandLine="*\\\\APPCMD.EXE install module /name:*"))\n(EventID="4688" (CommandLine="*\\\\APPCMD.EXE install module /name:*"))
```
...
```
(EventID="1" CommandLine IN ["*\\\\APPCMD.EXE install module /name:*"])\n(EventID="4688" CommandLine IN ["*\\\\APPCMD.EXE install module /name:*"])
```
