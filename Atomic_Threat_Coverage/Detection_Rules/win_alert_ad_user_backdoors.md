...
| ATT&amp;CK Technique | <ul><li>[T1098: Account Manipulation](https://attack.mitre.org/tactics/T1098)</li></ul>                             |
...
| Trigger              | <ul><li>[('Account Manipulation', 'T1098')](../Triggers/('Account Manipulation', 'T1098').md)</li></ul>  |
| Severity Level       | high                                                                                                                                                 |
