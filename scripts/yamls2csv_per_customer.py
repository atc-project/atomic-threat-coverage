...
def main(**kwargs):
    ...
    customers_list = get_customers(alerts)
    pivoting = []
    analytics = []
    result = []
                    ...
                    for lp in logging_policies:
                        ...
                        for rp in rps:
                            ...
                            for ra in ras:
                                ...
                                for customer in alert['customer']:
    ...
    for dn in dn_list:
        ...
        pivot = [dn_category, dn_platform, dn_type, dn_channel, dn_provider, dn_title, '', '']
        for field in dn['fields']:
            analytics.append([field] + pivot)
    ...
    with open('../generated_analytics/analytics.csv', 'w', newline='') as csvfile:
        ...
        alertswriter.writerow(['customer', 'tactic','technique','detection_rule','category', 'platform', 'type', 'channel', 'provider',
